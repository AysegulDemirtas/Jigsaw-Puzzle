...
public class ImageLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private PicassoImage target = new PicassoImage();
    ...
    private void initBitmap() {
        if (null == image_test) {
            //image_test = BitmapFactory.decodeResource(getResources(), R.drawable.arilia);


            //Picasso.with(getContext()).load("http://www.ybu.edu.tr/images/ybu_2.JPG").into(loadtarget);




            Picasso.with(getContext()).load("http://www.ybu.edu.tr/images/ybu_2.JPG").into(target);
    ...
    private class PicassoImage implements Target {
        ...
        public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom loadedFrom) {
            ...
            imagePieces = ImageSpliter.splitImage(image_test, piece);

            Toast.makeText(getContext(),"Loaded"+imagePieces.size(),Toast.LENGTH_LONG).show();
        ...
        public void onBitmapFailed(Drawable drawable) {
            ...
            Toast.makeText(getContext(),"Faile",Toast.LENGTH_LONG).show();
        }

        @Override
        public void onPrepareLoad(Drawable drawable) {

            Toast.makeText(getContext(),"Prepare",Toast.LENGTH_LONG).show();
